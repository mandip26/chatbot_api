...
SECRET_KEY = 'django-insecure-%033p&5c^qpz1-%epgx6^igi_$oy+z0(jr^q$$h29izw3mil$0'
...
# Add DEBUG renderers if in development
if DEBUG:
...
# Ollama settings
OLLAMA_QA = {
    'VECTORSTORE_PATH': os.environ.get('VECTORSTORE_PATH', 'vectorstore/db_faiss_json'),
